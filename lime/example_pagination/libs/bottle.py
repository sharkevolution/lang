...
if __name__ == '__main__':
    ...
    _cmd_parser = OptionParser(usage="usage: %prog [options] package.module:project")
...
class Route(object):
    ...
    def get_config(key, default=None):
        ''' Lookup a config field and return its value, first checking the
            route.config, then route.project.config.'''
...
class Bottle(object):
    ...
    def __init__(self, catchall=True, autojson=True):
        ...
        #: A :class:`ConfigDict` for project specific configuration.
    ...
    def merge(self, routes):
        ''' Merge the routes of another :class:`Bottle` application or a list of
            ...
            'owner', meaning that the :data:`Route.project` attribute is not
            changed. '''
    ...
    def add_route(self, route):
        ''' Add a route object, but do not change the :data:`Route.project`
            attribute.'''
...
class BaseRequest(object):
    ...
    @DictProperty('environ', 'bottle.project', read_only=True)
    def app(self):
    ...
    @property
    def url(self):
        """ The full request URI including hostname and scheme. If your project
...
def make_default_app_wrapper(name):
    ''' Return a callable that relays calls to the current default project. '''
...
# Initialize project stack (create first empty Bottle project)
